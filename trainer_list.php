	...
	<div class="container-fluid pb-1 pt-3">
			<div class="row">
				<div class="col-sm-12 col-md-12 col-xl-12 col-lg-12" style="background:#066A61;">
					<h4 style="text-align:center; padding:10px; color:white;"> Trainer Information</h4>
				</div>
			</div>
		</div>
...
<br /><br />
	<div class="container-fluid">
		...
		<?php 
		$s=1;
		$sql=" Select * from personnel_basic_info where status='Active' and designation in('Trainer','Administrator') ";
